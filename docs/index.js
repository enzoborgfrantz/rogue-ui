!(function(e) {
    ...
    (function(e) {
      ...
      var _ = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'.split(''),
        ...
        T = function(e) {
          var t = '',
            n = void 0;
          for (n = e; n > S; n = Math.floor(n / S)) t = _[n % S] + t;
          return _[n % S] + t;
        },
        E = function(e) {
          for (
      ...
      z = (function(e) {
        function t(n, r, o) {
          ...
          return (
            ...
            (a.componentSizes = []),
            (a.size = u.length),
            (a.components = u.reduce(function(e, t) {
        ...
        return (
          ...
          (t.prototype.inject = function(e, t, n) {
            ...
            for (
              ...
              var s = t[c];
              L(a, s, u + l) && ((r.css += ' ' + s), (l += 1));
            }
            if (((this.componentSizes[i] += l), null != n)) {
              var f = this.el.getAttribute(B);
              this.el.setAttribute(B, f ? f + ' ' + n : n);
            }
          }),
      ...
      var H,
          ...
          create: function() {
            for (
              ...
              i &&
                ...
                e.push(new z(a, 'true' === a.getAttribute(W), a.textContent));
            }
            return new Q(
              function(e) {
                ...
                if (
                  ((t.type = 'text/css'),
                  t.setAttribute(B, ''),
                  t.setAttribute(W, e ? 'true' : 'false'),
                  !document.head)
                )
                  throw new Error('');
                return document.head.appendChild(t), new z(t, e);
              },
              e,
              t
            );
        ...
        W = 'data-styled-components-is-local',
        ...
        Y = (function(e) {
          function t() {
            return A(this, t), F(this, e.apply(this, arguments));
          }
          return (
            M(t, e),
            (t.prototype.getChildContext = function() {
              var e;
              return ((e = {})[K] = this.props.sheet), e;
            }),
      ...
      Y.childContextTypes = (((H = {})[K] = p.a.oneOfType([
        p.a.instanceOf(Q),
        p.a.instanceOf(J),
      ]).isRequired),
      H);
      var X = (function() {
          ...
          return (
            ...
            (e.prototype.toReactElement = function(e) {
              var t,
                n = (((t = {})[B] = this.names.join(' ')),
                (t[W] = this.isLocal.toString()),
                t),
                r = j();
              return (
                r && (n.nonce = r),
        ...
        J = (function() {
          function e() {
            A(this, e),
              (this.instance = Q.clone(Q.instance)),
              (this.instance.isStreaming = !1);
          }
          return (
            (e.prototype.collectStyles = function(e) {
              if (this.closed) throw new Error('');
              return s.a.createElement(Y, { sheet: this.instance }, e);
            }),
      ...
      (pe.childContextTypes = (((ue = {})[ce] = p.a.func), (ue[se] = fe), ue)),
        (pe.contextTypes = (((le = {})[se] = fe), le));
      var de = {};
      function he(e, t) {
        for (
        ...
        switch (o) {
          case 3:
            (r ^= ye(e, a)), (r = ve((r ^= e.charCodeAt(a + 2) << 16), n));
            break;
          case 2:
            r = ve((r ^= ye(e, a)), n);
            break;
          case 1:
            r = ve((r ^= e.charCodeAt(a)), n);
        }
        return (r = ve((r ^= r >>> 13), n)), (r ^= r >>> 15) >>> 0;
      }
      function me(e, t) {
        return (
          e.charCodeAt(t++) +
          ...
          return (function() {
            function r(e, t, n) {
              A(this, r),
                ...
                (this.componentId = n),
                Q.instance.hasInjectedComponent(this.componentId) ||
                  Q.instance.deferredInject(n, !0, ['']);
            }
            return (
              (r.prototype.generateAndInjectStyles = function(r, o) {
                ...
                var u = t(this.rules, r),
                  l = he(this.componentId + u.join('')),
                  c = o.stylesCacheable,
                  s = o.getName(l);
                if (void 0 !== s) return c && (this.lastClassName = s), s;
                var f = e(l);
                if ((c && (this.lastClassName = s), o.alreadyInjected(l, f)))
                  return f;
                var p = n(u, '.' + f);
        ...
        ke = (function(e, t) {
              ...
              return (
                ...
                (t.prototype.generateAndInjectStyles = function(e, t) {
                  var n = this.constructor,
                    r = n.attrs,
                    o = n.componentStyle,
                    a = (n.warnTooManyClasses, this.context[K] || Q.instance);
                  if (o.isStatic && void 0 === r)
                    return o.generateAndInjectStyles(de, a);
                ...
                (t.prototype.render = function() {
                  ...
                  k(a) ? (l.innerRef = t) : (l.ref = t);
                  var s = Object.keys(this.props).reduce(function(t, n) {
                    var r;
                    return (
                      'innerRef' === n ||
                        'className' === n ||
                        (i && ((r = n), !Z.test(r) && !ee(r.toLowerCase()))) ||
                        (t[n] = e.props[n]),
                      t
                    );
                  }, l);
                  return Object(c.createElement)(a, s);
                }),
                t
              );
            })(c.Component);
          return function o(a, i, u) {
            var l,
              ...
              s =
                void 0 === c
                  ? te(a) ? 'styled.' + a : 'Styled(' + ne(a) + ')'
                  : c,
              f = i.componentId,
              d =
                void 0 === f
                  ? (function(t, r) {
                      var o = 'string' != typeof t ? 'sc' : ie(t),
                        a = void 0;
              ...
              g =
                i.displayName && i.componentId
                  ? ie(i.displayName) + '-' + i.componentId
                  : d,
              b = new e(void 0 === y ? u : y.concat(u), v, g),
              x = (function(e) {
                function n() {
                  return A(this, n), F(this, e.apply(this, arguments));
                }
                return (
                  M(n, e),
                  (n.withComponent = function(e) {
                    var t = i.componentId,
                      r = D(i, ['componentId']),
                      a = t && t + '-' + (te(e) ? e : ie(ne(e))),
                      l = I({}, r, { componentId: a, ParentComponent: n });
                    return o(e, l, u);
                  }),
                  N(n, null, [
                    {
            ...
            return (
              (x.contextTypes = (((l = {})[ce] = p.a.func),
              (l[se] = fe),
              (l[K] = p.a.oneOfType([p.a.instanceOf(Q), p.a.instanceOf(J)])),
              l)),
              (x.displayName = s),
        ...
        _e = (function(e, t, n) {
          return function(r) {
            ...
            var u = n.apply(void 0, [r].concat(a)),
              l = he(JSON.stringify(u).replace(/\s|\\n/g, '')),
              c = Q.instance.getName(l);
            if (c) return c;
            var s = e(l);
            if (Q.instance.alreadyInjected(l, s)) return s;
            var f = t(u, s, '@keyframes');
            return Q.instance.inject('sc-keyframes-' + s, !0, f, l, s), s;
          };
        })(T, C, E),
        Se = ((function(e, t) {})(C, E),
        (function(e, t) {
  ...
  function(e, t, n) {
    ...
    i(i.S + i.F * !H, 'Symbol', {
      ...
      A.prototype[D] || n(9)(A.prototype, D, A.prototype.valueOf),
      f(A, 'Symbol'),
      f(Math, 'Math', !0),
      f(r.JSON, 'JSON', !0);
  },
  ...
  function(e, t, n) {
    ...
    e.exports = function(e, t, n, m, y, v, g) {
      ...
      var b,
        ...
        S = !1,
        T = e.prototype,
        E = T[p] || T['@@iterator'] || (y && T[y]),
        O = (!d && E) || C(y),
        P = y ? (_ ? C('entries') : O) : void 0,
        j = ('Array' == t && T.entries) || E;
      if (
        (j &&
  ...
  function(e, t, n) {
          ...
          return (
            ...
            (r.inflate = function() {
              ...
              r.state.inflating ||
                ...
                (r.animationTimeout = setTimeout(function() {
                  r.state.inflating && (n && n(), r.setState({ max: !0 }));
                }, t)));
            }),
            (r.deflate = function() {
    ...
    var T = S,
      E = '#F8F6F6',
      O = Object(f.b)(['from{transform:scale(0.4);}to{transform:scale(1);}']),
      P = Object(f.b)(
        ['from,to{border-color:transparent;}50%{border-color:', ';}'],
        E
      ),
      j = Object(f.b)(['from{opacity:0;}to{opacity:1;}']),
      A = Object(f.b)(['from{opacity:1;}to{opacity:0;}']),
      N = n(68),
      I = n.n(N),
      M = (n(145),
      (function(e) {
      ...
      U = f.a.div.withConfig({ displayName: 'FistBump__FistBumpWrapper' })([
        'user-select:none;position:relative;height:120px;display:flex;flex-direction:column;align-items:center;justify-content:center;-webkit-tap-highlight-color:transparent;&:hover{cursor:pointer;}',
      ]),
      z = f.a.div.withConfig({ displayName: 'FistBump__FistBumpStyle' })(
        [
          'user-select:none;text-align:center;background:url(https://i.imgur.com/KwJVsF5.png);width:120px;height:120px;background-size:contain;transform:scale(0.4);',
          ';',
        ],
        function(e) {
          var t = e.inflating,
      ...
      H = f.a.div.withConfig({ displayName: 'FistBump__ScreenCrack' })([
        'user-select:none;position:absolute;top:50%;left:50%;width:180px;height:120px;margin:-85px -75px;background-position:center;background-size:contain;background:url(https://i.imgur.com/HunRuaV.png);pointer-events:none;background-repeat:round;transform:rotate(180deg);',
      ]),
      V = function(e) {
        ...
        return o()(T, {
          component: function(e) {
            ...
            return o()(
              ...
              void 0,
              o()(z, { inflating: r, animationDuration: t }),
              o()(
                F,
    ...
    var G = f.a.div.withConfig({ displayName: 'src__Page' })(
        [
          'padding:15vh 10vw 0;box-sizing:border-box;width:100vw;height:100vh;background:linear-gradient(0deg,',
          ',',
          ');',
        ],
        '#CF4647',
      ...
      ne = Object(f.a)(te).withConfig({ displayName: 'src__LinkButton' })(
        [
          'text-decoration:none;font-weight:600;border:1px solid ',
          ";border-radius:3px;padding:5px;font-family:'Michroma',sans-serif;",
        ],
        E
      ),
      re = f.a.div.withConfig({ displayName: 'src__TypeWritersWrapper' })([
      ...
      o()(
        ...
        o()(
          ...
          o()(
            ...
            void 0,
            o()(Y, { style: { margin: 0 } }, void 0, 'Components')
          ),
          o()(
            J,
            {},
    ...
    var D = {
        Children: {
          ...
          forEach: function(e, t, n) {
            if (null == e) return e;
            (t = O(null, null, t, n)), null == e || j(e, '', N, t), P(t);
          },
          count: function(e) {
  ...
  function(e, t, n) {
    ...
    'accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode x-height xlink:actuate xlink:arcrole xlink:href xlink:role xlink:show xlink:title xlink:type xml:base xmlns:xlink xml:lang xml:space'
      ...
      x.injectDOMPropertyConfig(E),
      x.injectDOMPropertyConfig(A);
    var M = {
      _caughtError: null,
      _hasCaughtError: !1,
      _rethrowError: null,
    ...
    function je() {
      return 'value' in Oe._root ? Oe._root.value : Oe._root[Ee()];
    }
            ...
            a
              ? (Ke &&
                  (Xe || a !== qe.compositionStart
                    ...
                    : ((Oe._root = r), (Oe._startText = je()), (Xe = !0))),
    ...
    var St = !1;
    function Tt() {
      xt && (xt.detachEvent('onpropertychange', Et), (wt = xt = null));
    }
    function Et(e) {
    ...
    function Ot(e, t, n) {
      'topFocus' === e
        ? (Tt(), (wt = n), (xt = t).attachEvent('onpropertychange', Et))
        : 'topBlur' === e && Tt();
    }
    function Pt(e) {
    ...
    function zo(e, t, n, r, o) {
      ...
      for (var u in (Po(t, n, No), (r = null), n))
        n.hasOwnProperty(u) &&
          ((a = n[u]),
          'children' === u
            ? 'string' == typeof a
            ...
            switch (b) {
              ...
              case j:
                if (
                  ...
                  ke > 0 &&
                    void 0 !==
                      (l = Ve(Oe, $e, t, e, de, pe, Ge.length, a, i)) &&
          ...
          switch (b) {
            ...
            case R:
              ...
              f === Y ? (f = 0) : me + T === 0 && ((_e = 1), ($e += '\0')),
                ke * Ae > 0 && Ve(Ee, $e, t, e, de, pe, Ge.length, a, i),
                (pe = 1),
                de++;
              break;
            case j:
        ...
        if (
          ...
          if (((Ge = u.join(',') + '{' + Ge + '}'), ye * he != 0)) {
            switch ((2 !== ye || ze(Ge, 2) || (he = 0), he)) {
              case ue:
                Ge = Ge.replace(y, ':' + O + '$1') + Ge;
                break;
              case ie:
                Ge =
                  Ge.replace(m, '::' + E + 'input-$1') +
                  Ge.replace(m, '::' + O + '$1') +
      ...
      function Ue(e, t, n, r) {
        ...
        if (944 === p)
          return (function(e) {
            ...
            return (
              (o = r + o + ';'),
              1 === ye || (2 === ye && ze(o, 1)) ? E + o + o : o
            );
          })(f);
        if (0 === ye || (2 === ye && !ze(f, 1))) return f;
        switch (p) {
          case 1015:
            return f.charCodeAt(9) === B ? E + f + f : f;
          case 951:
          ...
          case 1019:
          case 983:
            return E + f + O + f + P + f + f;
          case 883:
            return f.charCodeAt(8) === B ? E + f + f : f;
          case 932:
            if (f.charCodeAt(4) === B)
              switch (f.charCodeAt(5)) {
                ...
                case 115:
                  return E + f + P + f.replace('shrink', 'negative') + f;
                case 98:
                  return E + f + P + f.replace('basis', 'preferred-size') + f;
              }
            return E + f + P + f + f;
          case 964:
            return E + f + P + 'flex-' + f + f;
          case 1023:
            ...
            return (
              ...
              E + 'box-pack' + c + E + f + P + 'flex-pack' + c + f
            );
          case 1005:
            return a.test(f)
              ? f.replace(o, ':' + E) + f.replace(o, ':' + O) + f
              : f;
          case 1e3:
          ...
          case 975:
            ...
            (p =
              ...
              case 102:
                f =
                  f.replace(c, E + (p > 102 ? 'inline-' : '') + 'box') +
                  ';' +
                  f.replace(c, E + c) +
                  ';' +
                  f.replace(c, P + c + 'box') +
            ...
            if (f.charCodeAt(5) === B)
              switch (f.charCodeAt(6)) {
                case 105:
                  return (
                    (c = f.replace('-items', '')),
                    E + f + E + 'box-' + c + P + 'flex-' + c + f
                  );
                case 115:
                  return E + f + P + 'flex-item-' + f.replace(S, '') + f;
                default:
                  return (
                    E +
                    f +
          ...
          case 953:
            if (
              ...
              return (
                (c = f.substring(s - 3)),
                'width:' + E + c + 'width:' + O + c + 'width:' + c
              );
            break;
          case 962:
            if (
              ((f = E + f + (102 === f.charCodeAt(5) ? P + f : '') + f),
              n + r === 211 &&
                105 === f.charCodeAt(13) &&
  ...
  function(e, t, n) {
    ...
    (r = function() {
      ...
      return function(e) {
        ...
        return function(n, r, o, a, i, u, l, c, s) {
          switch (n) {
            case 1:
  ...
  function(e, t, n) {
    n(120), (e.exports = n(0).Object.getPrototypeOf);
  },
  function(e, t, n) {
    var r = n(46),
      o = n(65);
  ...
  function(e, t, n) {
    n(127), n(130), (e.exports = n(37).f('iterator'));
  },
  function(e, t, n) {
    'use strict';
    var r = n(128)(!0);
    ...
    e.exports = function(e, t, n, y, v, g) {
      ...
      if (!(n & f)) {
        var T = k && m.call(e, '__wrapped__'),
          E = _ && m.call(t, '__wrapped__');
        if (T || E) {
          var O = T ? e.value() : e,
            P = E ? t.value() : t;
          return g || (g = new r()), v(O, P, n, y, g);
        }
      }
  ...
  function(e, t, n) {
    ...
    e.exports = function(e, t, n, r, C, _, S) {
      switch (n) {
        ...
        case v:
          var E = r & c;
          if ((T || (T = l), e.size != t.size && !E)) return !1;
          var O = S.get(e);
          if (O) return O == t;
          (r |= s), S.set(e, t);
